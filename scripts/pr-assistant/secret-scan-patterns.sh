...
# Secret scanning is intentionally conservative: prefer false positives over false negatives.
# If this becomes noisy, tighten patterns rather than disabling the guardrail.
