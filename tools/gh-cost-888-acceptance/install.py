"""Install the reviewed acceptance fix into the local #888 autopilot under its lock.
...
MODULE = BASE / "cost_888_literal.py"
...
def install(expected_sha, dry_run):
    ...
    try:
        ...
        new_module = (HERE / "literal.py").read_bytes()
        ...
        if old_module is not None:
            write_atomic(backup / "cost_888_literal.py", old_module)
