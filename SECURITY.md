...
- **Incident response**: Follow [WARP_SECURITY_INCIDENT_RESPONSE.md](https://github.com/merglbot-public/docs/blob/main/WARP_SECURITY_INCIDENT_RESPONSE.md)
- **Secrets management**: Follow [WARP_SECRETS_NAMING_AND_LOGGING.md](https://github.com/merglbot-public/docs/blob/main/WARP_SECRETS_NAMING_AND_LOGGING.md)
...
- Follow the [GitHub Actions Global Rules](https://github.com/merglbot-public/docs/blob/main/WARP_GITHUB_ACTIONS_GLOBAL_RULES.md)
